...
import net.mcreator.weedmod.procedures.CannabisPlantOnBlockRightClickProcedure;
...
public class CannabisPlantBlock extends WeedmodModElements.ModElement {
	@ObjectHolder("weedmod:cannabis_plant")
	public static final Block block = null;

	public CannabisPlantBlock(WeedmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cannabis_plant");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			CannabisPlantOnBlockRightClickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
