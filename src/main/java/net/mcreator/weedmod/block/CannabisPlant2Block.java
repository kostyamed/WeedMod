...
public class CannabisPlant2Block extends WeedmodModElements.ModElement {

	@ObjectHolder("weedmod:cannabis_plant_2")
	public static final Block block = null;

	public CannabisPlant2Block(WeedmodModElements instance) {
		super(instance, 5);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cannabis_plant_2");
		}
